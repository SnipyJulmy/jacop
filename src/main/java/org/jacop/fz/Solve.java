...
// 	System.out.println(table);
        ...
        if(count == 1)
        {// only solve kind => default search
...
// 								     new JaCoP.search.MostConstrainedStatic<Var>(),
    ...
    void printSolution()
    {
        ...
        // last Var is the value of the objective function

        int value = ((IntVar)dictionary.outputVariables.get(dictionary.outputVariables.size()-1)).value();
        if( value > bestSol)
        {
            bestSol = value;
            org.jacop.fz.Fz2jacop.bestSolution = dictionary.outputVariables;
        }
